...
public class admin extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        adapter=new infoadapter(admin.this,list);
        ...
        if ("amazon".equals(item2)){

            LinearLayout layout=(LinearLayout) findViewById(R.id.scroll);
            View v1= getLayoutInflater().inflate(inflatecompany,layout,false);
            layout.addView(v1);
           /* Intent in=new Intent(admin.this,admin.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_addcompany) {
            // Handle the camera action
            Intent in=new Intent(admin.this,addcompany.class);
            startActivity(in);
        } else if (id == R.id.nav_noti) {
            Intent in=new Intent(admin.this,notification.class);
            startActivity(in);
